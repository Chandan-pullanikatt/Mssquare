    ...
    <div className="space-y-8 pb-20">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Create Placeholder */}
          <Link href="/admin/courses/create" className="border-4 border-dashed border-gray-100 rounded-[2rem] p-8 flex flex-col items-center justify-center text-center group hover:border-[#8b5cf6]/30 transition-all hover:bg-purple-50/10 h-full min-h-[400px]">
