...
const adminSidebarItems = [
  ...
  { name: "Website Content", href: "/cms-admin/content", icon: Globe },
  { name: "Courses", href: "/cms-admin/courses", icon: BookOpen },
  { name: "Blog Posts", href: "/cms-admin/blog", icon: FileText },
  { name: "Media Manager", href: "/cms-admin/media", icon: ImageIcon },
  { name: "Users", href: "/cms-admin/users", icon: Users },
  { name: "Leads & Inquiries", href: "/cms-admin/leads", icon: MessageSquare },
  { name: "Enrollments", href: "/cms-admin/enrollments", icon: UserCheck },
  { name: "FAQ & Legal", href: "/cms-admin/faq-legal", icon: ShieldCheck },
  { name: "Analytics", href: "/cms-admin/analytics", icon: BarChart3 },
  { name: "SEO & Settings", href: "/cms-admin/settings", icon: SearchCode },
];
