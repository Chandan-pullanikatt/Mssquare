  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link href="/cms-admin/blog/create" className="px-5 py-3 rounded-2xl bg-white border border-gray-100 text-gray-600 font-bold text-sm hover:bg-gray-50 transition-all flex items-center gap-2">
            <Plus size={18} />
            <span>Write Blog</span>
          </Link>
          <Link href="/cms-admin/courses/create" className="px-5 py-3 rounded-2xl bg-[#8b5cf6] text-white font-bold text-sm shadow-lg shadow-[#8b5cf6]/20 hover:-translate-y-0.5 transition-all flex items-center gap-2">
            <Plus size={18} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <DataTable
          ...
          actions={
            <Link href="/cms-admin/enrollments" className="text-[#8b5cf6] text-sm font-bold hover:underline">
              View All
            </Link>
          }
        />
        ...
        <DataTable
          ...
          actions={
            <Link href="/cms-admin/users" className="text-[#8b5cf6] text-sm font-bold hover:underline">
              View All
            </Link>
          }
        />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white border border-gray-100 rounded-[2rem] p-8 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { label: "Edit Landing Page", href: "/cms-admin/content/landing", icon: Globe },
              { label: "Manage Courses", href: "/cms-admin/courses", icon: BookOpen },
              { label: "Blog Management", href: "/cms-admin/blog", icon: FileText },
              { label: "Media Library", href: "/cms-admin/media", icon: ImageIcon },
              { label: "FAQ & Legal", href: "/cms-admin/faq-legal", icon: SearchCode },
              { label: "Leads & Contacts", href: "/cms-admin/leads", icon: Users },
              { label: "User Management", href: "/cms-admin/users", icon: Users },
              { label: "SEO & Settings", href: "/cms-admin/settings", icon: SearchCode },
            ].map((item: any, i) => (
        ...
        <div className="bg-[#8b5cf6] rounded-[2rem] p-8 text-white shadow-[0_20px_40px_rgba(139,92,246,0.2)]">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-6 border-t border-white/10">
              ...
              <Link href="/cms-admin/leads" className="w-full py-3 bg-white text-[#8b5cf6] rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-purple-50 transition-all">
                Handle Leads
                <ArrowRight size={16} />
              </Link>
            </div>
