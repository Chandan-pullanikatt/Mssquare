      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-[#8b5cf6] rounded-[2.5rem] p-8 text-white shadow-xl shadow-[#8b5cf6]/20 relative overflow-hidden group">
            ...
            <Link href="/business-admin/analytics" className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest bg-white text-[#8b5cf6] px-6 py-3 rounded-xl transition-all hover:gap-3">
              View Report
