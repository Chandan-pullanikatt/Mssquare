    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Link href="/admin/cms/courses/create">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div key={course.id} className="bg-white border border-gray-100 rounded-[2rem] overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.02)] group hover:shadow-xl hover:border-[#8b5cf6]/20 transition-all flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="flex items-center gap-2 mt-auto">
                  <Link href={`/admin/cms/courses/edit/${course.id}`} className="flex-1">
          ...
          {/* Create Placeholder */}
          <Link href="/admin/cms/courses/create" className="border-4 border-dashed border-gray-100 rounded-[2rem] p-8 flex flex-col items-center justify-center text-center group hover:border-[#8b5cf6]/30 transition-all hover:bg-purple-50/10 h-full min-h-[400px]">
